...
export function PrivacyScreen() {
  return (
    <Screen>
      ...
      <SectionCard title="AI access" subtitle="Gemini-backed responses">
        <Text style={styles.body}>
          Krsna AI uses Gemini-backed AI responses through the configured backend. Free daily AI access is included and resets automatically each day.
        </Text>
      </SectionCard>
